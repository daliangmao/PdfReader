...
public class ReaderView
    ...
    private ReaderViewDelegate mDelegate;
    ...
    public void SetDelegate(ReaderViewDelegate delegate){
        mDelegate = delegate;
    }
    ...
    public static interface ReaderViewDelegate{
        void pageChange(int mCurrent);
    }
}
